        ...
        <div className=''>
            ...
            <div className='w-full flex justify-center items-center lg:items-start lg:justify-between  lg:gap-10 lg:flex-row flex-col '>
                <div className='lg:w-1/2 '>
                    <Bodytext text={<><i>“Keregalam Kattu, Maragalam Nedu”</i> – “Build lakes, plant trees” – is a Kannada saying attributed to the mother of Kempe Gowda, the governor under the Vijayanagara Empire famed for founding Bengaluru city in the 1530s. Kempe Gowda is remembered today for creating nearly a hundred lakes and lining the city’s roads with trees, shaping the city’s identity as the ‘City of Lakes’. Over the years, many lakes have been lost but a few like Venkateshpura Lake now stand as renewed hope amid rapid urbanisation.</>} />
                </div>
            ...
            <div className='w-full flex justify-center items-center lg:items-start lg:justify-between  lg:gap-10 lg:flex-row flex-col '>
                ...
                <div className='lg:w-1/2 '>
                    <Bodytext text={<>The Jarabandemma Temple, perched on a rocky outcrop by the lake, is a historic sacred site believed to date back to the Mysore kings’ era. As per local tradition, it was a resting place for soldiers on the move. During the month of Shravan, villagers gathered here to pray for rain, offering Ambali, a millet-based dish. A spring from a natural cleft in the rock near the entrance is seen as a miraculous gift. Inside the temple, uncarved stones represent powerful protectors – Jarubandemma, Akkayamma and the Saptamatheyaru – central to the community. </>} />
