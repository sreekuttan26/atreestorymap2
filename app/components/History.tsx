        ...
        <div className=''>
            ...
            <div className='w-full flex justify-center items-center lg:items-start lg:justify-between  lg:gap-10 lg:flex-row flex-col '>
                <div className='lg:w-1/2 '>
                    <Bodytext text={<><i>“Keregalam Kattu, Maragalam Nedu”</i> – “Build lakes, plant trees” – is a Kannada saying attributed to the mother of Kempe Gowda, the governor under the Vijayanagara Empire, famed for founding the Bengaluru city in the 1530s. Kempe Gowda is remembered today for creating nearly a hundred lakes and lining the city’s roads with trees, thereby shaping the city’s identity as the ‘City of Lakes’. Over the years, many lakes have been lost, but a few, like Venkateshpura Lake, now stand as a renewed source of hope amid rapid urbanisation.</>} />
                </div>
