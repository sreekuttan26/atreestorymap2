...
const Joininghands = () => {
  return (
    <div>
        <Heading text="Joining hands"/>
        <Bodytext text="It was clear that people living around Venkateshpura Lake were united in their desire to save it. But meaningful restoration requires a shared vision, which means ensuring that all voices – local communities, government institutions, researchers and other local actors – come together and align their needs with a shared vision for the future."/>
