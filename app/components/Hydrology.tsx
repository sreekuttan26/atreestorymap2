...
const Hydrology = () => {
  return (
    <div>
         ...
         <Bodytext text={<span>
           The lakes in Bengaluru were constructed to harvest rainwater along the streams, and they flowed across an undulating terrain, connected by <i>rajakaluves</i> or stormwater drains. This network of lakes formed a seamless cascading system from a higher to lower elevation along three main valleys of the city – Hebbal-Nagawara, Koramangala-Challaghatta and Vrishabhavathi.
         </span>}/>
         <Bodytext text={<span>
