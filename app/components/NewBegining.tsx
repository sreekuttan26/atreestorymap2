    ...
    return (
        <div className='flex flex-col gap-5 p-5 '>
            ...
            <ul className="list-disc px-4  mb-4 space-y-2">
                ...
                <li>However, the work is far from over.</li>
                ...
                <li>Restoration, after all, is not an endpoint but a continuous process that requires upkeep and shared responsibility.</li>
