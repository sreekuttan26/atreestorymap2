...
const Keyactors = () => {
    ...
    const spotlightData = [
        ...
        },
        {
            ...
            description: "The grassland flanking the lake had been the grazing grounds for cattle, sheep and goat, known locally as gomala. It was among the last remaining patches in the neighbourhood with easy access to grass and water. Pastoralists who brought their livestock here not only sustained their livelihoods but supplied milk to the surrounding city.",
        },
        {
            id: 'migrant',
            title: 'Migrants',
